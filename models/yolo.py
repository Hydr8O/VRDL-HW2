...
from utils.general_no_kd import check_anchor_order, make_divisible, check_file
...
class Model(nn.Module):
    ...
    def __init__(self, cfg='yolov4.yaml', ch=3, nc=None):
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    na = (len(anchors[0]) // 2) if isinstance(
        anchors,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,
                        default='yolov4.yaml', help='model.yaml')
